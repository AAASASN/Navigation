...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // MARK: - здесь вносим изменения в сткоку
//        guard let _ = (scene as? UIWindowScene) else { return }
    ...
    func createUITapBarContoller() -> UITabBarController {
        ...
        // изменяем цвет
        tapBarController.tabBar.backgroundColor = UIColor(red: 1.00, green: 0.95, blue: 0.74, alpha: 0.67)
    ...
    func createFirstNavigationController() -> UINavigationController {
        let someNavigationController = UINavigationController(rootViewController: FeedViewController())
